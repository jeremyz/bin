...
bin_extra="calculator converter e_phys editje edje_viewer elmdentica elsa emage emote empower enjoy enki envision ephoto Eterm eve expedite exquisite eyelight phonebook rage sticky-notes"
