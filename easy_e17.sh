...
eweather exalt-client exebuf execwatch flame forecasts iiirk itask language mail mem moon mpdule net news penguins photo places quickaccess \
rain screenshot skel slideshow snow taskbar tclock tiling uptime weather winlist-ng winselector wlan xkbswitch"
bin_extra="calculator clouseau converter e_phys editje edje_viewer elfe elmdentica elsa emote empower enjoy enki epdf envision \
