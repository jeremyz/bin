...
efl_basic="eina eet eobj evas ecore efreet eio eeze e_dbus embryo edje exquisite evas_generic_loaders emotion ethumb emap libeweather elementary expedite"
