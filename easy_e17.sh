...
efl_basic="efl e_dbus exquisite evas_generic_loaders emotion ethumb emap libeweather elementary expedite"
efl_extra="azy clouseau efx enlil ensure esskyuehl etam exactness libast shellementary"
